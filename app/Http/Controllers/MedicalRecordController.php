...
class MedicalRecordController extends Controller
{
    ...
    public function store(Request $request, Pet $pet)
    {
        ...
        $validated = $request->validate([
            ...
            'applied_medications.*.name' => 'required_with:applied_medications|string',
            'applied_medications.*.dosage' => 'nullable|string',
            'applied_medications.*.frequency' => 'nullable|string',
            'applied_medications.*.duration' => 'nullable|string',
            'applied_medications.*.notes' => 'nullable|string',
        ]);
