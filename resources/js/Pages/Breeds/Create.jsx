...
export default function Create({ auth }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Agregar Raza al Catálogo</h2>}
        >
            <Head title="Agregar Raza" />
                        ...
                        <form onSubmit={submit} className="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows="3"
                                    className="mt-1 block w-full rounded-md border-gray-300 dark:bg-gray-900 border-gray-700 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm"
                                    placeholder="Temperamento, necesidades especiales..."
                                ></textarea>
