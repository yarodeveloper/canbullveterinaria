...
export default function Create({ auth }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Alta de Sucursal</h2>}
        >
                ...
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-2xl sm:rounded-[2rem]">
                        <div className="p-8 border-b dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
                            <h3 className="text-sm font-black text-gray-900 dark:text-white uppercase tracking-[0.2em] mb-1">Nueva Sucursal</h3>
                            <p className="text-xs text-gray-500 font-bold italic">Completa la información oficial de la unidad de negocio.</p>
                        </div>
