                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-[#1B2132] overflow-hidden shadow-sm sm:rounded-[2rem] border dark:border-gray-700/50">
                        ...
                        <div className="p-0">
                            {hospitalizations.data.length > 0 ? (
                                <ul className="divide-y divide-gray-100 dark:divide-gray-800 text-slate-700 dark:text-slate-300">
                                    {hospitalizations.data.map((hospitalization) => (
                                                ...
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <div className="flex items-center min-w-0 gap-4 flex-1">
                                                        <div className="flex-shrink-0 group-hover:scale-110 transition-transform">
                                                            <PetAvatar pet={hospitalization.pet} className="h-10 w-10 border-2 border-slate-100 dark:border-gray-700 group-hover:border-white shadow-sm" />
                                                        </div>
                        ...
                        <div className="p-6 border-t border-slate-100 dark:border-slate-700/50 bg-slate-50/30 dark:bg-gray-900/40">
                            <Pagination links={hospitalizations.links} />
                        </div>
                    </div>
                </div>
            </div>
