                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-red-50 dark:bg-red-900/10 p-4 rounded-lg space-y-3">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                placeholder="Nombre"
                                                className="mt-1 block w-full rounded-md border-gray-200 focus:border-brand-primary focus:ring-brand-primary dark:bg-gray-900 dark:border-gray-700 text-sm"
                                            />
                                        </div>
                                        <div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="mt-1 block w-full rounded-md border-gray-300 focus:border-brand-primary focus:ring-brand-primary dark:bg-gray-900 dark:border-gray-700 uppercase"
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            rows="3"
                                            className="mt-1 block w-full rounded-md border-gray-300 focus:border-brand-primary focus:ring-brand-primary dark:bg-gray-900 dark:border-gray-700 text-sm"
                                        ></textarea>
                                    </div>
                                    <div className="mt-4">
                                        <BehaviorSelector
