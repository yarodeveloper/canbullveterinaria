                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-[2rem] border dark:border-gray-700">
                        <div className="p-4 sm:p-6 text-gray-900 dark:text-gray-100">
                            <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
                                <h3 className="text-sm font-black text-slate-800 dark:text-white uppercase tracking-widest hidden sm:block">Listado de Pacientes</h3>
                                                    ...
                                                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                                                        ...
                                                        <div className="flex items-center min-w-0 gap-4 flex-1 relative w-full sm:w-auto">
                                                            <div className="relative flex-shrink-0 group-hover:scale-110 transition-transform">
                                                                <PetAvatar pet={pet} className={`h-10 w-10 border-2 border-slate-50 dark:border-gray-700 group-hover:border-white/50 rounded-full ${pet.status === 'deceased' ? 'grayscale opacity-70' : ''}`} />
                                                                {pet.status === 'deceased' && (
                                                                    <span className="absolute -top-1 -right-1 text-[8px] bg-red-600 text-white rounded-full px-1 border border-white" title="Fallecido">✞</span>
                                                                )}
                                                            </div>
                                                            <div className="min-w-0 flex-1">
                                                                <div className="flex items-center gap-2">
                                                                    ...
                                                                    {pet.status === 'deceased' && (
                                                                        <span className="text-[8px] font-black bg-red-100 text-red-600 px-1.5 py-0.5 rounded uppercase tracking-tighter group-hover:bg-white group-hover:text-red-600 border border-red-200">
                                                                            Fallecido
                                                                        </span>
                                                                    )}
                                                                </div>
                                                        ...
                                                        <div className="flex items-center gap-6 w-full sm:w-auto justify-between sm:justify-end">
                                                            <div className="text-left sm:text-right">
                                                                ...
                                                                <div className="flex items-center gap-2 justify-start sm:justify-end">
                                                                    <span className="text-[11px] font-bold text-gray-700 dark:text-gray-300 group-hover:text-white truncate max-w-[120px] uppercase">
                                                                        {pet.owner.name}
                                                                    </span>
                                                                    {pet.owner.phone && (
                                                                        <div className="flex gap-1">
                                                                            <button
                                                                                ...
                                                                                title="Llamar"
                                                                                className="h-4 w-4 inline-flex items-center justify-center bg-blue-100 group-hover:bg-white group-hover:text-brand-primary text-blue-600 rounded-full hover:scale-110 transition"
                                                                            >
                                                            ...
                                                            <div className="text-right hidden sm:block w-16">
                                                                <p className="text-[9px] font-black text-gray-400 group-hover:text-white/60 uppercase tracking-widest mb-0.5">Peso</p>
                                                                <p className="text-[11px] font-bold text-gray-700 dark:text-gray-300 group-hover:text-white">
