                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                        <button
                            ...
                            className="px-5 py-2 bg-indigo-600 text-white rounded-xl font-black text-xs uppercase hover:bg-indigo-700 transition shadow-lg shadow-indigo-200 flex items-center gap-2"
                        >
                            <span>📝</span> + Tarea
                        </button>
                        <button
                            onClick={() => openCreateModal(selectedDate)}
                            className="px-5 py-2 bg-brand-primary text-white rounded-xl font-black text-xs uppercase hover:opacity-90 transition shadow-lg shadow-brand-primary/40 flex items-center gap-2"
                        >
                            <span>📅</span> + Cita Clínica
                        </button>
                    </div>
                </div>
            }
                                        ...
                                        <div>
                                            ...
                                            <div className={view === 'grid' ? "grid grid-cols-1 md:grid-cols-2 gap-4" : "space-y-3"}>
                                                {pendingAppointments.map(apt => (
                                                    <div key={`apt-${apt.id}`} className={`bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-md transition group ${view === 'grid' ? 'p-4 flex flex-col' : 'p-3 flex items-center gap-4'}`}>
                                                        ...
                                                        <div className={`flex items-center gap-3 ${view === 'grid' ? 'mt-auto pt-4 border-t dark:border-gray-700 justify-between' : ''}`}>
                                                            ...
                                                            <div className="flex gap-1.5">
                                                                <button onClick={() => openEditModal(apt)} className="p-1.5 bg-gray-50 dark:bg-gray-700 text-gray-400 hover:text-brand-primary hover:bg-white dark:hover:bg-gray-600 rounded-lg transition border border-gray-100 dark:border-gray-600" title="Editar">
